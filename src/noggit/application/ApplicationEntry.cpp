...
int main(int argc, char *argv[])
{
  ...
  // Preserve the legacy application/organization identity so existing QSettings
  // continue to resolve, while exposing the community build name to the UI.
  q_application.setApplicationName ("Noggit");
  q_application.setApplicationDisplayName ("Noggit_Gold");
