...
public:
  ...
  /// Fields
  // WotLK 3.3.5a (12340) LightParams.dbc has 9 fields:
  // ID, HighlightSky, LightSkyboxID, CloudTypeID, Glow, and four water alpha floats.
  // There is no Flags field in this WDBC layout.
  static const size_t ID = 0;                    // uint
  static const size_t highlightSky = 1;          // uint/bool
  static const size_t skybox = 2;                // uint ref to LightSkyBox
  static const size_t cloudTypeID = 3;           // uint
  static const size_t glow = 4;                  // float
  static const size_t water_shallow_alpha = 5;   // float
  static const size_t water_deep_alpha = 6;      // float
  static const size_t ocean_shallow_alpha = 7;   // float
  static const size_t ocean_deep_alpha = 8;      // float
};
