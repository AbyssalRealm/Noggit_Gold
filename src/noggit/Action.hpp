...
namespace Noggit
{
    ...
    private:
        ...
        std::vector<std::pair<MapChunk*, ChunkLiquidChangeCache>> _chunk_liquid_pre;
        std::vector<std::pair<MapChunk*, ChunkLiquidChangeCache>> _chunk_liquid_post;
