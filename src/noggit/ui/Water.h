...
namespace Noggit
{
  ...
  namespace Ui
  {
    ...
    public:
      ...
      void beginPaintStroke(glm::vec3 const& cursor_pos);
      void endPaintStroke();
      ...
      bool follow_terrain() const;
      bool use_liquids_intersect() const;
    ...
    private:
      ...
      BoolToggleProperty _follow_terrain;
      BoolToggleProperty _cursor_intersect_liquids;
      ...
      glm::vec3 _lock_pos;
      glm::vec3 _stroke_pos = glm::vec3(0.0f);
