...
void main()
{
  ...
  if(draw_selection_overlay != 0 && instances[instanceID].AreaIDColor_Pad2_DrawSelection.g != 0)
  {
    out_color.rgb = mix(vec3(0.10, 0.45, 1.0), out_color.rgb, 0.55);
  }
  else if(draw_selection_overlay != 0 && instances[instanceID].AreaIDColor_Pad2_DrawSelection.b != 0)
  {
    out_color.rgb = mix(vec3(0.10, 1.0, 0.35), out_color.rgb, 0.55);
  }
  else if(draw_selection_overlay != 0 && instances[instanceID].AreaIDColor_Pad2_DrawSelection.a != 0)
  {
   out_color.rgb = mix(vec3(1.0), out_color.rgb, 0.5);
  }
